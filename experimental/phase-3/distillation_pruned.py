...
# Initialize a fresh student model and load pruned weights
student = DistilBertForSequenceClassification.from_pretrained(BASELINE_MODEL)
student.load_state_dict(torch.load(PRUNED_MODEL), strict=False)
...
student.train()
for epoch in range(1):  # Increase later if needed
...
print("✅ Distillation (with pruned model) complete.")
...
print("✅ Phase-3 (distillation of pruned model) done! Saved in:", BASE_OUTPUT)
